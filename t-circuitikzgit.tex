\def\pgfcircversion{git:3a1205d}
\def\pgfcircversiondate{2017/02/05}
...
\else
	--($(\tikztostart) ! .0001 ! (\tikztotarget)$) %ugly workaround to get correct linejoins
\fi
	...
	\else
		...
		\fi
		($(\tikztostart) ! .9999 ! (\tikztotarget)$)--(\tikztotarget)% -- needed to get correct linejoins
	\fi
