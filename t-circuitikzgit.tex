\def\pgfcircversion{git:cf79f4a}
...
\pgfdeclareshape{en amp}
	{
	  ...
	  \savedanchor\up{%
		...
		\pgf@x=.5\pgf@x
			...
			\pgf@circ@res@left = \pgf@x
	    \pgfpointlineattime{
			\pgfkeysvalueof{/tikz/circuitikz/tripoles/en amp/up pos}}{
			\pgfpoint{
	...
	\endpgfscope
		...
		\pgftext[base,y=-3ex,at=\pgfpoint{.3\pgf@circ@res@left}{\pgf@circ@res@up}]{\pgfkeysvalueof{/tikz/circuitikz/tripoles/en amp/font2} $\Delta$}
