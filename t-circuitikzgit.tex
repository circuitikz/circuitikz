\def\pgfcircversion{git:eefcd8e}
\def\pgfcircversiondate{2019/03/26}
...
\ctikzset{tripoles/op amp/font/.initial= \fontsize{10}{0}\selectfont\boldmath}%absolute font size needed!
...
\ctikzset{tripoles/en amp/font/.initial= \fontsize{10}{0}\selectfont\boldmath}%absolute font size needed!
\ctikzset{tripoles/en amp/font2/.initial= \fontsize{14}{0}\selectfont\boldmath}%absolute font size needed!
