\def\pgfcircversion{git:d93ab9a}
\def\pgfcircversiondate{2016/06/02}
...
\ctikzset{bipoles/cuteinductor/lower coil height/.initial=.1}	
...
\ctikzset{bipoles/vcuteinductor/lower coil height/.initial=.1}	
