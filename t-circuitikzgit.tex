...
\def\pgfcircversion{1.2.1-unreleased-6408324}
\def\pgfcircversiondate{2020/06/30}
    ...
    % see comments for the "above" part (similar)
        ...
        \else
            ...
            \ifpgf@circuit@bipole@voltage@raised
                ...
                coordinate (pgfcirc@Vto) at ($(pgfcirc@Vlab)+(pgfcirc@Vto@flat)-(pgfcirc@mid)$)
                coordinate (pgfcirc@Vfrom) at ($(pgfcirc@Vlab)+(pgfcirc@Vfrom@flat)-(pgfcirc@mid)$)
            \fi
        \fi
    \else
        \ifpgf@circuit@europeanvoltage
