\def\pgfcircversion{git:a083122}
\def\pgfcircversiondate{2019/11/05}
...
\ctikzset{tripoles/bjt/external pins width/.initial=0.3}
\pgfkeys{/tikz/external pins width/.add code={}{\ctikzset{tripoles/bjt/external pins width=#1}}}
...
\long\def\declarebjt#1{
    \pgfdeclareshape{bjt#1}{
        ...
        \saveddimen{\external}{\pgfmathsetlength{\pgf@x}{%
            \ctikzvalof{tripoles/bjt/external pins width}*\ctikzvalof{\ctikzclass/scale}*\pgf@circ@Rlen}}
