...
\def\pgfcircversion{1.1.3-unreleased-ab7a2a1}
\def\pgfcircversiondate{2020/05/24}
...
%%
%% Guarded against a possible inclusion of the key in the
%% fpu library
%%
\pgfkeysifdefined{/pgf/use fpu reciprocal}{}{
