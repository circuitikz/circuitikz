\def\pgfcircversion{git:5ecee99}
\def\pgfcircversiondate{2016/06/01}
...
\ctikzset{bipoles/cuteinductor/coil aspect/.initial=.4}%percentage of inductor width, which is covered by lower coil
...
\ctikzset{bipoles/vcuteinductor/coil aspect/.initial=.4}%percentage of inductor width, which is covered by lower coil
...
\pgfcircdeclarebipole{}{\ctikzvalof{bipoles/cuteinductor/height}}{cuteinductor}{\ctikzvalof{bipoles/cuteinductor/height}}{\ctikzvalof{bipoles/cuteinductor/width}}{
	...
	\pgf@circ@res@up = \ctikzvalof{bipoles/cuteinductor/coil height}\pgf@circ@Rlen
	\pgf@circ@res@down =\ctikzvalof{bipoles/cuteinductor/lower coil height}\pgf@circ@Rlen
...
\pgfcircdeclarebipole{}{\ctikzvalof{bipoles/vcuteinductor/height}}{vcuteinductor}{\ctikzvalof{bipoles/vcuteinductor/height}}{\ctikzvalof{bipoles/vcuteinductor/width}}{
	...
	\pgfscope
		\pgfsetarrowsend{latex'}
		\pgfpathmoveto{\pgfpoint{.4\pgf@circ@res@left}{.7\pgf@circ@res@down}}
		\pgfpathlineto{\pgfpoint{.4\pgf@circ@res@right}{\pgf@circ@res@up}}
		\pgfusepath{draw}
	\endpgfscope

	\pgf@circ@res@up = \ctikzvalof{bipoles/vcuteinductor/coil height}\pgf@circ@Rlen
	\pgf@circ@res@down =\ctikzvalof{bipoles/vcuteinductor/lower coil height}\pgf@circ@Rlen
...
\def\pgf@circ@bipole@path#1#2{
	...
	\else
		\ifpgf@circuit@bipole@strokedsymbol%draw line thrue symbol(e.g. diodes)
			\@ifundefined{pgf@anchor@#1shape@strokepathstart}{%if special path-anchors are defined, use them!
		...
		\else
			\@ifundefined{pgf@anchor@#1shape@pathstart}{%if special path-anchors are defined, use them!
