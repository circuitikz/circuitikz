\def\pgfcircversion{git:6095c81}
\def\pgfcircversiondate{2016/07/06}
...
\ifpgf@circuit@bipole@inverted
%Invert position for correct anchor calculation
	\ifpgf@circuit@bipole@voltage@below
...
\fi
		...
		\ifpgf@circuit@bipole@inverted
		%revert to original position for correct placement
			\ifpgf@circuit@bipole@voltage@below
				\pgf@circuit@bipole@voltage@belowfalse
			\else
				\pgf@circuit@bipole@voltage@belowtrue
...
\ctikzset{inverted/false/.code = {\ctikzsetvalof{invert value}{1}}}
