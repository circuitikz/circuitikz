...
\def\pgfcircversion{1.0.0-pre3}-0049e2b}
\def\pgfcircversiondate{2020/02/02}
...
%%% rheed switch
\ctikzset{bipoles/rheed/height/.initial=.4}
\ctikzset{bipoles/rheed/width/.initial=.8}% 0.35 in nos
\ctikzset{bipoles/rheed/depth/.initial=.4}
...
\pgfcircdeclarebipolescaled{switches}
{}
{\ctikzvalof{bipoles/rheed/depth}}
{rheed}
{\ctikzvalof{bipoles/rheed/height}}
{\ctikzvalof{bipoles/rheed/width}}
{
    % this is designed to be the same as a "nos".
    \pgfmathsetmacro{\@@tmpx}{0.9*\ctikzvalof{bipoles/nos/width}/\ctikzvalof{bipoles/rheed/width}}
    \pgfmathsetmacro{\@@tmpy}{\ctikzvalof{bipoles/nos/height}/\ctikzvalof{bipoles/rheed/height}}
    \pgfscope
        \pgf@circ@setlinewidth{bipoles}{\pgfstartlinewidth}
        % eclosure
...
% Rheed switches
\def\pgf@circ@rheed@path#1{\pgf@circ@bipole@path{rheed}{#1}}
\compattikzset{rheed/.style = {\circuitikzbasekey, /tikz/to path=\pgf@circ@rheed@path, l=#1}}
