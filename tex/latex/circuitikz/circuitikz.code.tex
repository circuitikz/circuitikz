...
\ctikzset{monopoles/vcc/width/.initial=.25}
\ctikzset{monopoles/match/width/.initial=.4}
\ctikzset{monopoles/oscillator/width/.initial=.35}
...
\ctikzset{tripoles/circulator/height/.initial=.85}
\ctikzset{tripoles/circulator/width/.initial=.85}
\ctikzset{tripoles/circulator/margin/.initial=.75}
