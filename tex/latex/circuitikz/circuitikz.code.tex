...
% Option "box" for nodes and twoports
\newif\ifpgf@circuit@box
\pgfkeys{/tikz/box/.add code={}{\pgf@circuit@boxtrue}}
\ctikzset{box/.add code={}{\pgf@circuit@boxtrue}}
...
\ctikzset{monopoles/oscillator/width/.initial=.55}
...
\ctikzset{bipoles/vco/width/.initial=.55}
...
\ctikzset{bipoles/amp/width/.initial=.4}
...
\ctikzset{tripoles/mixer/width/.initial=0.55}
\ctikzset{tripoles/adder/width/.initial=0.55}
\ctikzset{tripoles/circulator/width/.initial=.55}
