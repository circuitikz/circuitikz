...
%	\compattikzset{#1/.style= {to path=#2, \circuitikzbasekey, l=##1}}%
%}
...
\compattikzset{ammeter/.style= {\circuitikzbasekey, /tikz/to path=\pgf@circ@ammeter@path, l=#1}}
\compattikzset{voltmeter/.style= {\circuitikzbasekey, /tikz/to path=\pgf@circ@voltmeter@path, l=#1}}
...
\compattikzset{voltage source/.style = {\ifpgf@circuit@europeanvoltage european \else american \fi voltage source, \circuitikzbasekey/bipole/is voltage=true, v=#1}}
\compattikzset{current source/.style = {\ifpgf@circuit@europeancurrent european \else american \fi current source, \circuitikzbasekey/bipole/is current=true, i=#1}}
\compattikzset{controlled voltage source/.style = {\ifpgf@circuit@europeanvoltage european \else american \fi controlled voltage source, \circuitikzbasekey/bipole/is voltage=true, v=#1}}
\compattikzset{controlled current source/.style = {\ifpgf@circuit@europeancurrent european \else american \fi controlled current source, \circuitikzbasekey/bipole/is current=true, i=#1}}
...
\compattikzset{empty varcap/.style = {\circuitikzbasekey, /tikz/to path=\pgf@circ@emptyvarcap@path}}
	...
	\compattikzset{Schottky diode/.style = {\ifpgf@circuit@fulldiode full \else empty \fi Schottky diode}}
	\compattikzset{Zener diode/.style = {\ifpgf@circuit@fulldiode full \else empty \fi Zener diode}}
	\compattikzset{tunnel diode/.style = {\ifpgf@circuit@fulldiode full \else empty \fi tunnel diode}}
	\compattikzset{photodiode/.style = {\ifpgf@circuit@fulldiode full \else empty \fi photodiode}}
	\compattikzset{led/.style = {\ifpgf@circuit@fulldiode full \else empty \fi led}}
	\compattikzset{varcap/.style = {\ifpgf@circuit@fulldiode full \else empty \fi varcap}}
	\compattikzset{diode/.style = {\ifpgf@circuit@fulldiode full \else empty \fi diode}}
...
% short forms
\compattikzset{vsource/.style = {voltage source = #1}}
\compattikzset{isource/.style = {current source = #1}}
\compattikzset{cisource/.style = {controlled current source = #1}}
\compattikzset{cvsource/.style = {controlled voltage source = #1}}
\compattikzset{vsourcesin/.style = {sinusoidal voltage source = #1}}
\compattikzset{vsourcesquare/.style = {square voltage source = #1}}
\compattikzset{isourcesin/.style = {sinusoidal current source = #1}}
\compattikzset{cisourcesin/.style = {controlled sinusoidal current source = #1}}
\compattikzset{cvsourcesin/.style = {controlled sinusoidal  voltage source = #1}}

\compattikzset{controlled vsource/.style = {controlled voltage source = #1}}
\compattikzset{controlled isource/.style = {controlled current source = #1}}
\compattikzset{controlled vsourcesin/.style = {controlled sinusoidal  voltage source = #1}}
\compattikzset{controlled isourcesin/.style = {controlled sinusoidal current source = #1}}

\compattikzset{R/.style= {resistor = #1}}
\compattikzset{vR/.style= {variable resistor = #1}}
\compattikzset{phR/.style= {photoresistor = #1}}
\compattikzset{thR/.style= {thermistor = #1}}
\compattikzset{thRp/.style= {thermistor ptc= #1}}
\compattikzset{thRn/.style= {thermistor ntc= #1}}
\compattikzset{pR/.style= {potentiometer = #1}}
\compattikzset{C/.style = {capacitor = #1}}
\compattikzset{pC/.style = {polar capacitor = #1}}
\compattikzset{vC/.style = {variable capacitor = #1}}
\compattikzset{L/.style = {inductor = #1}}
\compattikzset{vL/.style = {variable inductor = #1}}
\compattikzset{V/.style = {voltage source = #1}}
\compattikzset{cV/.style = {controlled voltage source = #1}}
\compattikzset{sV/.style = {sinusoidal voltage source = #1}}
\compattikzset{sqV/.style = {square voltage source = #1}}
\compattikzset{csV/.style = {controlled sinusoidal voltage source = #1}}
\def\pgf@temp#1{ 
	\compattikzset{V#1/.style = {voltage source, v#1=##1} } 
	\compattikzset{cV#1/.style = {controlled  voltage source, v#1=##1} } 
	\compattikzset{sV#1/.style = {sinusoidal  voltage source, v#1=##1} } 
	\compattikzset{csV#1/.style = {controlled sinusoidal voltage source, v#1=##1} } 
}
\pgf@temp{_>} \pgf@temp{_<} \pgf@temp{^>} \pgf@temp{^<} 
\pgf@temp{>} \pgf@temp{<} \pgf@temp{^} \pgf@temp{_} 
\compattikzset{I/.style = {current source = #1}}
\compattikzset{cI/.style = {controlled current source = #1}}
\compattikzset{sI/.style = {sinusoidal current source = #1}}
\compattikzset{csI/.style = {controlled sinusoidal current source = #1}}
\def\pgf@temp#1{ 
	\compattikzset{I#1/.style = {current source, i#1=##1} } 
	\compattikzset{cI#1/.style = {controlled current source, i#1=##1} } 
	\compattikzset{sI#1/.style = {sinusoidal current source, i#1=##1} } 
	\compattikzset{csI#1/.style = {controlled sinusoidal current source, i#1=##1} } 
}
\pgf@temp{_>} \pgf@temp{_<} \pgf@temp{^>} \pgf@temp{^<} 
\pgf@temp{>_} \pgf@temp{<_} \pgf@temp{>^} \pgf@temp{<^} 
\pgf@temp{>} \pgf@temp{<} \pgf@temp{^} \pgf@temp{_} 
\compattikzset{Do/.style = {empty diode}}
\compattikzset{tDo/.style = {empty tunnel diode}}
\compattikzset{zDo/.style = {empty Zener diode}}
\compattikzset{sDo/.style = {empty Schottky diode}}
\compattikzset{pDo/.style = {empty photodiode}}
\compattikzset{leDo/.style = {empty led}}
\compattikzset{VCo/.style = {empty varcap}}
\compattikzset{D*/.style = {full diode}}
\compattikzset{tD*/.style = {full tunnel diode}}
\compattikzset{zD*/.style = {full Zener diode}}
\compattikzset{sD*/.style = {full Schottky diode}}
\compattikzset{pD*/.style = {full photodiode}}
\compattikzset{leD*/.style = {full led}}
\compattikzset{VC*/.style = {full varcap}}
\compattikzset{D/.style = {diode}}
\compattikzset{tD/.style = {tunnel diode}}
\compattikzset{zD/.style = {Zener diode}}
\compattikzset{sD/.style = {Schottky diode}}
\compattikzset{pD/.style = {photodiode}}
\compattikzset{leD/.style = {led}}
\compattikzset{VC/.style = {varcap}}

\compattikzset{Tr/.style = {triac}}
\compattikzset{Mr/.style = {memristor}}
\compattikzset{Ty/.style = {thyristor}}

\compattikzset{cspst/.style = {closing switch = #1}}
\compattikzset{ospst/.style = {opening switch = #1}}

\compattikzset{afuse/.style = {asymmetric fuse=#1}}
