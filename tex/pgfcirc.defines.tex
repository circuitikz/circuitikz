...
% \ctikzset{mechanics/scale/.initial=1.0}
% \ctikzset{others/scale/.initial=1.0}
...
% support shapes: probably no need, they are specials anyways
% \ctikzset{switches/scale/.initial=1.0}
% \ctikzset{logic gates/scale/.initial=1.0}
% \ctikzset{chips/scale/.initial=1.0}
% \ctikzset{seven segment displays/scale/.initial=1.0}
