...
\ctikzset{bipoles/oosourcetrans/vectorgroup/.initial=.01}

% % % oootransformer
\ctikzset{bipoles/ooosource/height/.initial=.6}
\ctikzset{bipoles/ooosource/width/.initial=.6}
\ctikzset{bipoles/ooosource/circlesize/.initial=.6}%circlesize+circleoffset should be =1
\ctikzset{bipoles/ooosource/circleoffset/.initial=.4}%circlesize+circleoffset should be =1
\ctikzset{bipoles/ooosource/vectorgroup/.initial=.01}
