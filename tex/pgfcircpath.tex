...
\def\pgfcirc@activate@bipole#1#2#3{% path name, base node name, style name
    \expandafter\def\csname pgf@circ@#1@path\endcsname##1{\pgf@circ@bipole@path{#2}{##1}}%
    \compattikzset{#3/.style={\circuitikzbasekey, /tikz/to path=\csname pgf@circ@#1@path\endcsname, l=##1}}%
}
\def\pgfcirc@activate@bipole@simple#1{\pgfcirc@activate@bipole{#1}{#1}{#1}}

%% Path definition with the new mechanism
%% Mechanical

\pgfcirc@activate@bipole@simple{spring}
\pgfcirc@activate@bipole@simple{inerter}
\pgfcirc@activate@bipole@simple{mass}
\pgfcirc@activate@bipole@simple{damper}
\pgfcirc@activate@bipole@simple{viscoe}
