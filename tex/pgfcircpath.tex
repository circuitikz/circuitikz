...
\def\pgfcircresetpath{
	\ctikzset{bipole/name=, bipole/label/name=, bipole/label/position=90, 
		bipole/reversed=false, bipole/kind=,
	  	...
	  	bipole/nodes/left=none, bipole/nodes/right=none, bipole/is voltage=false,bipole/is voltageoutsideofsymbol=false,bipole/is strokedsymbol=true,
...
\compattikzset{ZZener diode/.style = {\comnpatname \ifpgf@circuit@fulldiode full \else empty \fi ZZener diode}}
...
\compattikzset{thyristor/.style =  {\circuitikzbasekey, /tikz/to path=\pgf@circ@fullthyristor@path}}
...
\compattikzset{triac/.style =  {\circuitikzbasekey, /tikz/to path=\pgf@circ@emptytriac@path}}
...
\compattikzset{Tr/.style = {\comnpatname empty triac}}
