...
\pgfkeys{tikz/prim/xdelta/.add code={}{\pgf@circ@prim@xdeltatrue}}
...
\pgfkeys{tikz/sec/xdelta/.add code={}{\pgf@circ@sec@xdeltatrue}}
...
\pgfkeys{tikz/tert/xdelta/.add code={}{\pgf@circ@tert@xdeltatrue}}
...
\pgfkeys{tikz/upper/xdelta/.add code={}{\pgf@circ@upper@xdeltatrue}}
...
\ctikzset{sources/symbol/xdelta scale/.initial={1}}
...
\ctikzset{sources/symbol/xdelta rot/.initial={0}}
...
\ctikzset{sources/symbol/xdelta split/.initial={0.58}}
...
% extended delta
\def\pgf@circ@xdelta#1{
    \pgfscope
        \pgftransformscale{-.015*\ctikzvalof{\ctikzclass/symbol/xdelta scale}*\pgf@circ@res@up*#1}
        \pgftransformrotate{\ctikzvalof{\ctikzclass/symbol/xdelta rot}}
        \def\pgfcircmathresult{\expandafter\pgf@circ@stripdecimals\pgf@circ@direction\pgf@nil}
            \pgftransformrotate{-\pgfcircmathresult}
        \pgf@circ@setlinewidth{bipoles}{\pgfstartlinewidth}
        \pgf@circ@set@relative@thickness{symbol/thickness}
        \pgfmathsetmacro{\@@split}{\ctikzvalof{sources/symbol/xdelta split}}
        \pgfmathsetmacro{\@@nosplit}{1-\ctikzvalof{sources/symbol/xdelta split}}
        \pgfpathmoveto{\pgfpointpolar{90}{\@@split\pgf@circ@res@up}}
        \pgfpathlineto{\pgfpointpolar{-30}{\@@split\pgf@circ@res@up}}
        \pgfpathlineto{\pgfpointpolar{-150}{\@@split\pgf@circ@res@up}}
        \pgfpathclose
        \pgfusepath{stroke}
        \pgfscope
            \pgftransformshift{\pgfpointpolar{90}{\@@split\pgf@circ@res@up}}
            \pgfpathmoveto{\pgfpointorigin}
            \pgfpathlineto{\pgfpointpolar{90+30}{\@@nosplit\pgf@circ@res@up}}
            \pgfusepath{stroke}
        \endpgfscope
        \pgfscope
            \pgftransformshift{\pgfpointpolar{-30}{\@@split\pgf@circ@res@up}}
            \pgfpathmoveto{\pgfpointorigin}
            \pgfpathlineto{\pgfpointpolar{-30+30}{\@@nosplit\pgf@circ@res@up}}
            \pgfusepath{stroke}
        \endpgfscope
        \pgfscope
            \pgftransformshift{\pgfpointpolar{-150}{\@@split\pgf@circ@res@up}}
            \pgfpathmoveto{\pgfpointorigin}
            \pgfpathlineto{\pgfpointpolar{-150+30}{\@@nosplit\pgf@circ@res@up}}
            \pgfusepath{stroke}
        \endpgfscope
    \endpgfscope
}
...
{\ctikzvalof{bipoles/oosourceatrans/width}}
{
    ...
    \ifpgf@circ@prim@delta
        ...
        \endpgfscope
    \else\ifpgf@circ@prim@xdelta
        \pgfscope
            \pgftransformxshift{\pgf@circ@res@other}
            \pgftransformrotate{\ctikzvalof{sources/symbol/prim rot}}
            \pgf@circ@xdelta{\ctikzvalof{bipoles/oosourceatrans/vectorgroupscale}}
        \endpgfscope
    ...
    \ifpgf@circ@upper@delta
        ...
        \endpgfscope
    \else\ifpgf@circ@upper@xdelta
        \pgfscope
            \pgftransformxshift{\pgf@circ@res@other}
            \pgftransformyshift{\pgf@circ@res@up}
            \pgftransformyshift{\vectorgroupoffset*\uppercirclesize*\pgf@circ@res@up}
            \pgftransformrotate{\ctikzvalof{sources/symbol/upper rot}}
            \pgf@circ@xdelta{\ctikzvalof{bipoles/oosourcetrans/vectorgroupscale}}
        \endpgfscope
...
\def\pgf@circ@ooo@anchor@base{
    \pgf@circ@scaled@Rlen=\classscale\pgf@circ@Rlen
...
\pgfcircdeclarebipolescaled{sources}
{
    % we need to save the class scale factor here because is used in plain (not saved) anchors
    \savedmacro{\classscale}{\edef\classscale{\ctikzvalof{\ctikzclass/scale}}}
...
% %     primary winding
    ...
    \else\ifpgf@circ@prim@xdelta
        \pgfscope
            \pgftransformxshift{-\vectorgroupoffset\pgf@circ@res@other}
            \pgftransformrotate{\ctikzvalof{sources/symbol/prim rot}}
            \pgf@circ@xdelta{\ctikzvalof{bipoles/ooosource/vectorgroupscale}}
        \endpgfscope
    \else\ifpgf@circ@prim@wye
        \pgfscope
            \pgftransformxshift{-\vectorgroupoffset\pgf@circ@res@other}
