...
\def\pgfcircdeclarethyristor#1#2#3{%name, fill (0-> black; 1-empty), extra code
    \pgfcircdeclarebipolescaled{diodes}
    {
...
%% Black thyristor
\pgfcircdeclarethyristor{fullthyristor}{0}{\pgfcirc@thyristor@simplegate}
%% Empty thyristor
\pgfcircdeclarethyristor{emptythyristor}{1}{\pgfcirc@thyristor@simplegate}
...
\pgfcircdeclarethyristor{fullgto}{0}{\pgfcirc@doublegate@gto@add}
\pgfcircdeclarethyristor{emptygto}{1}{\pgfcirc@doublegate@gto@add}
...
\pgfcircdeclarethyristor{fullgtobar}{0}{\pgfcirc@bargate@gto@add}
\pgfcircdeclarethyristor{emptygtobar}{1}{\pgfcirc@bargate@gto@add}
