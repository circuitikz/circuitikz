...
{
    \pgf@circ@res@other = \ctikzvalof{bipoles/oosourcetrans/vectorgroup} \pgf@circ@scaled@Rlen
...
% % %     % draw inner symbols
    ...
    \ifpgf@circ@prim@delta
        \pgfscope
            ...
            \pgftransformscale{.4\pgf@circ@res@other}
            \pgf@circ@delta
        \endpgfscope
    ...
    \else\ifpgf@circ@prim@wye
        \pgfscope
            \pgftransformxshift{.6\pgf@circ@res@left}
            \pgftransformscale{.5\pgf@circ@res@other}
            \pgf@circ@wye
        \endpgfscope
    ...
    \ifpgf@circ@sec@delta
        \pgfscope
            \pgftransformxshift{.6\pgf@circ@res@right}
            \pgftransformscale{.4\pgf@circ@res@other}
            \pgf@circ@delta
        \endpgfscope
...
\pgfcircdeclarebipolescaled{sources}
{
% setting the right anchor a bit to the left
    \anchor{right}{
            \northeast
            \pgf@x=.85\pgf@x
            \pgf@y=0pt
...
{ooosource}
{\ctikzvalof{bipoles/ooosource/height}}
{\ctikzvalof{bipoles/ooosource/width}}
{
    ...
    \pgfpointorigin
    \pgf@circ@setlinewidth{bipoles}{\pgfstartlinewidth}
    \pgfpathcircle{\pgfpoint{\ctikzvalof{bipoles/ooosource/circleoffset}\pgf@circ@res@left}{0}}
        {\ctikzvalof{bipoles/ooosource/circlesize}\pgf@circ@res@left}
    \pgf@circ@maybefill
    % up
    \pgfscope
        \pgftransformyshift{\ctikzvalof{bipoles/ooosource/circleoffset}\pgf@circ@res@down}
            \pgfpathcircle{\pgfpoint{\ctikzvalof{bipoles/ooosource/circleoffset}\pgf@circ@res@right}{0}}
                {\ctikzvalof{bipoles/ooosource/circlesize}\pgf@circ@res@right}
            \pgf@circ@maybefill
    \endpgfscope
    % down
    \pgfscope
        \pgftransformyshift{\ctikzvalof{bipoles/ooosource/circleoffset}\pgf@circ@res@up}
            \pgfpathcircle{\pgfpoint{\ctikzvalof{bipoles/ooosource/circleoffset}\pgf@circ@res@right}{0}}
                    {\ctikzvalof{bipoles/ooosource/circlesize}\pgf@circ@res@right}
            \pgf@circ@draworfill
    \endpgfscope
...
% %     secondary winding
    \ifpgf@circ@sec@delta
        \pgfscope
            \pgftransformshift{\pgfpoint{.6\pgf@circ@res@right}{.5\pgf@circ@res@up}}
            \pgftransformscale{.4\pgf@circ@res@other}
            \pgf@circ@delta
        \endpgfscope
...
% %     tertiary winding
    \ifpgf@circ@tert@delta
        \pgfscope
            \pgftransformshift{\pgfpoint{.6\pgf@circ@res@right}{.5\pgf@circ@res@down}}
            \pgftransformscale{.4\pgf@circ@res@other}
            \pgf@circ@delta
        \endpgfscope
