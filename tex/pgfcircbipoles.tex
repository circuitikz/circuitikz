...
\def\pgfcircdeclarethyristor#1#2#3{%name, fill (0-> black; 1-empty), extra code
    ...
    {\ctikzvalof{tripoles/thyristor/width}}
    {
        ...
        % draw the gate thing
        \pgfpathmoveto{\pgfpoint{\pgf@circ@res@step}{0pt}}
        \pgfpathlineto{\pgfpoint{2*\pgf@circ@res@step-\pgf@circ@res@other}{\ctikzvalof{tripoles/thyristor/diode height}\pgf@circ@res@up}}
        \pgfpathlineto{\pgfpoint{2*\pgf@circ@res@step-\pgf@circ@res@other}{\pgf@circ@res@up}}
...
%% Black thyristor
\pgfcircdeclarethyristor{fullthyristor}{0}{}
%% Empty thyristor
\pgfcircdeclarethyristor{emptythyristor}{1}{}
