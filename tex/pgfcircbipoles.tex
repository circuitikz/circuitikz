...
\pgfcircdeclarebipolescaled{sources}
{
    \anchor{centerprim}{
        \northeast
        \advance\pgf@x by -\ctikzvalof{bipoles/oosourceatrans/circlesize}\pgf@y
        \pgf@y=0pt\relax
    }
    \anchor{symbolprim}{
        \northeast
...
{\ctikzvalof{bipoles/oosourceatrans/width}}
{
    % we do not use the offset here; the circle is "seated" to the right side
    \pgf@circ@setlinewidth{bipoles}{\pgfstartlinewidth}
    \pgf@circ@res@other=\dimexpr\pgf@circ@res@right-\ctikzvalof{bipoles/oosourceatrans/circlesize}\pgf@circ@res@up\relax
    \pgfpathcircle{\pgfpoint{\pgf@circ@res@other}{0}}
        {\ctikzvalof{bipoles/oosourceatrans/circlesize}\pgf@circ@res@up}
    \pgf@circ@draworfill
    % draw arc
    \pgfpathmoveto{\pgfpoint{\pgf@circ@res@other}%
        {\ctikzvalof{bipoles/oosourceatrans/circlesize}*\pgf@circ@res@up}}
    \pgfpathcurveto{\pgfpoint{0.3\pgf@circ@res@left}{\ctikzvalof{bipoles/oosourceatrans/circlesize}\pgf@circ@res@up}}
        {\pgfpoint{0.5\pgf@circ@res@left}{\ctikzvalof{bipoles/oosourceatrans/circlesize}\pgf@circ@res@up}}
