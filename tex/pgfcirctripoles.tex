...
\pgfcircdeclaretransistor{nigfete}{}{%	
	\pgf@circuit@trans@depletiontypefalse
	\pgf@circuit@trans@ntypetrue
	\drawfetcore{nigfete}
...
\pgfcircdeclaretransistor{nigfetebulk}{}{%
	\pgf@circuit@trans@depletiontypefalse
	\pgf@circuit@trans@ntypetrue
...
\pgfcircdeclaretransistor{nigfetd}{}{%
...
\pgfcircdeclaretransistor{pigfete}{}{%
	\pgf@circuit@trans@depletiontypefalse
	\pgf@circuit@trans@ntypefalse
	\drawfetcore{pigfete}
      \pgfpathmoveto{\pgfpoint{\pgf@circ@res@right}{\pgf@circ@res@up}}
...
\pgfcircdeclaretransistor{pigfetebulk}{}{%
	\pgf@circuit@trans@depletiontypefalse
	\pgf@circuit@trans@ntypefalse
...
\pgfcircdeclaretransistor{pigfetd}{}{%
	\pgf@circuit@trans@depletiontypetrue
	\pgf@circuit@trans@ntypefalse
	\drawfetcore{pigfetd}
...
\pgfcircdeclaretransistor{isfet}{}{%
	\pgf@circuit@trans@ntypetrue
      \pgfpathmoveto{\pgfpoint{\pgf@circ@res@right}{\pgf@circ@res@up}}
      % DRAIN CONNECTION 
      \pgfpathlineto{\pgfpoint{\pgf@circ@res@right}
