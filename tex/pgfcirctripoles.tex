...
% Plain gm amp
\ctikzset{tripoles/plain gm amp/width/.initial=1.7}              % Total width
\ctikzset{tripoles/plain gm amp/port width/.initial=.7}          % Terminals length
\ctikzset{tripoles/plain gm amp/height/.initial=1.4}             % Left side of the trapezoid
\ctikzset{tripoles/plain gm amp/height 2/.initial=0.5}           % Right side of the trapezoid
\ctikzset{tripoles/plain gm amp/input height/.initial=.5}        % Input port vertical separation
\ctikzset{tripoles/plain gm amp/up pos/.initial=.45}             % Top and bottom anchor position
\ctikzset{tripoles/plain gm amp/font/.initial=\pgf@circ@font@tenbm}  % Absolute font size needed!
...
\pgfdeclareshape{plain gm amp}
{
    ...
    \savedanchor\northwest{%
        \pgfmathsetlength{\pgf@circ@scaled@Rlen}{\ctikzvalof{\ctikzclass/scale}\pgf@circ@Rlen}
        \pgf@y=\ctikzvalof{tripoles/plain gm amp/height}\pgf@circ@scaled@Rlen
        \pgf@y=.5\pgf@y
        \pgf@x=-\ctikzvalof{tripoles/plain gm amp/width}\pgf@circ@scaled@Rlen
        \pgf@x=.5\pgf@x
    }
    \anchor{east}{ \northwest \pgf@y=0pt \pgf@x=-\pgf@x  }
    \anchor{west}{ \northwest \pgf@y=0pt }
    ...
    \savedanchor\inOne{%
        ...
        \pgf@y=\ctikzvalof{tripoles/plain gm amp/height}\pgf@circ@scaled@Rlen
        \pgf@y=.5\pgf@y
        \pgf@y=\ctikzvalof{tripoles/plain gm amp/input height}\pgf@y
        \pgf@x=-\ctikzvalof{tripoles/plain gm amp/width}\pgf@circ@scaled@Rlen
        \pgf@x=.5\pgf@x
        \ifpgf@circuit@oa@iplusup\pgf@y=-\pgf@y\fi
    }
    ...
    \savedanchor\leftedge{%
        ...
        \pgf@x=-\ctikzvalof{tripoles/plain gm amp/width}\pgf@circ@scaled@Rlen
        \pgf@x=.5\pgf@x
        \pgf@x = \ctikzvalof{tripoles/plain gm amp/port width}\pgf@x
        \pgf@y=0pt
    }
    \anchor{leftedge}{\leftedge}
    \anchor{rightedge}{\leftedge \pgf@x =-\pgf@x }
    ...
    \savedanchor\up{%
        ...
        \pgf@circ@res@left = \pgf@x
        \pgfpointlineattime{
            \ctikzvalof{tripoles/plain gm amp/up pos}}{
            \pgfpoint{
            \ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@left}
        {\pgf@circ@res@up}}
        {\pgfpoint{\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@right}{0pt}}
    }
    \anchor{up}{
        \up
    }
    ...
    \pgf@circ@draw@component{
        ...
        \pgfscope
            ...
            \pgf@circ@setlinewidth{tripoles}{\pgflinewidth}
            \pgftransformxshift{\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@left}
            \pgf@circ@res@step=\pgf@circ@res@right
            \advance\pgf@circ@res@step by -\pgf@circ@res@left
            \pgf@circ@res@step=\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@step
            %Umrandung:
            \pgfpathmoveto{\pgfpoint{\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@right@double}{0}} %geändert startpunkt neu am ausgangsstrich
            \pgfpathlineto{\pgfpoint{\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@right@double}{\ctikzvalof{tripoles/plain gm amp/height 2}\pgf@circ@res@up}}%vom Ausgang nach oben
            \pgfpathlineto{\pgfpoint{0pt}{\pgf@circ@res@up}} %neu ecke links oben nach rechts oben
            \pgfpathlineto{\pgfpoint{0pt}{\pgf@circ@res@down}} %bei deneigängen runter
            \pgfpathlineto{\pgfpoint{\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@right@double}{\ctikzvalof{tripoles/plain gm amp/height 2}\pgf@circ@res@down}}%ecke links unten nach rechts unten
            \pgfpathclose
            \pgf@circ@draworfill
        \endpgfscope
        \pgfpathmoveto{\pgfpoint
            {\pgf@circ@res@left}
        {\ctikzvalof{tripoles/plain gm amp/input height}\pgf@circ@res@up}}
        \pgfpathlineto{\pgfpoint
            {\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@left}
        {\ctikzvalof{tripoles/plain gm amp/input height}\pgf@circ@res@up}}
        ...
        \pgfpathmoveto{\pgfpoint
            {\pgf@circ@res@left}
        {\ctikzvalof{tripoles/plain gm amp/input height}\pgf@circ@res@down}}
        \pgfpathlineto{\pgfpoint
            {\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@left}
        {\ctikzvalof{tripoles/plain gm amp/input height}\pgf@circ@res@down}}

        \pgfpathmoveto{\pgfpoint{\pgf@circ@res@right}{0pt}}
        \pgfpathlineto{\pgfpoint{\ctikzvalof{tripoles/plain gm amp/port width}\pgf@circ@res@right}{0pt}}
