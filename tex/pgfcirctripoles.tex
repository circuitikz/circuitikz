...
\long\def\drawigbtcore#1{
	...
	\pgfpathmoveto{\pgfpoint
		...
		{\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/base height}\pgf@circ@res@up+.5\pgflinewidth}}
	\pgfpathlineto{\pgfpoint
		{\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/gate width}\pgf@circ@res@left}
		{\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/base height}\pgf@circ@res@down-.5\pgflinewidth}}
	\pgfpathmoveto{\pgfpoint
		{\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/base width}\pgf@circ@res@left}
		{\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/base height}\pgf@circ@res@up+.5\pgflinewidth}}
	\pgfpathlineto{\pgfpoint
...
\pgfcircdeclaretransistor{pigbt}{
	...
	\anchor{G}{
         \northeast
         \pgf@circ@res@step=\pgfkeysvalueof{/tikz/circuitikz/tripoles/pigbt/conn height}\pgf@y
         \left
         \pgf@y=+\pgf@circ@res@step
	}
	\anchor{gate}{
...
\pgfcircdeclaretransistor{nigbt}{
	...
	\anchor{G}{
         \northeast
         \pgf@circ@res@step=\pgfkeysvalueof{/tikz/circuitikz/tripoles/nigbt/conn height}\pgf@y
         \left
         \pgf@y=-\pgf@circ@res@step
	}
	\anchor{gate}{
...
\pgfcircdeclaretransistor{Lpigbt}{
	\anchor{E}{
		\northeast
	}
	\anchor{emitter}{
	...
	\anchor{G}{
         \northeast
         \pgf@circ@res@step=\pgfkeysvalueof{/tikz/circuitikz/tripoles/Lpigbt/conn height}\pgf@y
         \left
         \pgf@y=+\pgf@circ@res@step
	}
	\anchor{gate}{
...
\pgfcircdeclaretransistor{Lnigbt}{
	\anchor{C}{
		\northeast
	}
	\anchor{collector}{
	...
	\anchor{G}{
         \northeast
         \pgf@circ@res@step=\pgfkeysvalueof{/tikz/circuitikz/tripoles/Lnigbt/conn height}\pgf@y
         \left
         \pgf@y=-\pgf@circ@res@step
	}
	\anchor{gate}{
...
\long\def\drawfetcore#1{
    ...
    \pgfpathmoveto{\pgfpoint
      {\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/gate width}\pgf@circ@res@left}
      {\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/gate height}\pgf@circ@res@up+.5\pgflinewidth}}
    \pgfpathlineto{\pgfpoint
      {\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/gate width}\pgf@circ@res@left}
      {\pgfkeysvalueof{/tikz/circuitikz/tripoles/#1/gate height}\pgf@circ@res@down-.5\pgflinewidth}}
    \pgfsetlinewidth{2\pgflinewidth}
    \pgfusepath{draw}
    \endpgfscope
	...
	\drawfetcore{pigfete}
     ...
     \ifpgf@circuit@bpt@drawgate	
      ...
      \pgfpathmoveto{\pgfpoint
        ...
        {\pgfkeysvalueof{/tikz/circuitikz/tripoles/pigfete/gate height}\pgf@circ@res@up}}
      %\pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{\pgf@circ@res@up+\pgf@circ@res@down}}
      \pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{\pgfkeysvalueof{/tikz/circuitikz/tripoles/pigfete/gate height}\pgf@circ@res@up}}
      \pgfusepath{draw}
      \fi
}
...
\pgfcircdeclarefet{pigfetebulk}{
	...
	\drawfetcore{pigfetebulk}
      ...
      %\pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{\pgf@circ@res@up+\pgf@circ@res@down}}
      \pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{\pgfkeysvalueof{/tikz/circuitikz/tripoles/pigfetebulk/gate height}\pgf@circ@res@up}}
      \pgfusepath{draw}
      \fi
}
...
\pgfcircdeclarefet{pigfetd}{
      ...
      \anchor{G}{
         \northeast
         \pgf@circ@res@step=\pgfkeysvalueof{/tikz/circuitikz/tripoles/pigfetd/gate height}\pgf@y
         \left
         \pgf@y=\pgf@circ@res@step
      }
      \anchor{gate}{
	...
	\drawfetcore{pigfetd}
     ...
     \ifpgf@circuit@bpt@drawgate	
      ...
      %\pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{\pgf@circ@res@up+\pgf@circ@res@down}}
      \pgfpathlineto{\pgfpoint{\pgf@circ@res@left}{\pgfkeysvalueof{/tikz/circuitikz/tripoles/pigfetd/gate height}\pgf@circ@res@up}}
      \pgfusepath{draw}
      \fi
}
