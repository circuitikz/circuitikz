...
\long\def\pgfcircdeclaretransistor#1#2#3{
    \pgfdeclareshape{#1}
    {
        \saveddimen{\scaledRlen}{\pgfmathsetlength{\pgf@x}{\ctikzvalof{transistors/scale}\pgf@circ@Rlen}}
        \anchor{center}{
            \pgfpointorigin
        }
...
\long\def\drawbodydiode#1{
    \pgfscope
        ...
        % 1) undo diode scale 2) apply transistor scale 3) apply bodydiode scale
        \pgfmathsetmacro{\@@BDscale}{\ctikzvalof{tripoles/#1/bodydiode scale}* \ctikzvalof{transistors/scale}/\ctikzvalof{diodes/scale}}
