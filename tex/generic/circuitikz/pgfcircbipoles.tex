...
\pgfcircdeclarebipole{}{\ctikzvalof{bipoles/pvsource/height}}{pvsource}{\ctikzvalof{bipoles/pvsource/height}}{\ctikzvalof{bipoles/pvsource/width}}{
	...
	\pgfscope
	\pgfsetarrowsend{latex'}
	\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right}{.8\pgf@circ@res@down}}
	\pgfpathlineto{\pgfpoint{.4\pgf@circ@res@right}{-0.3\pgf@circ@res@up}}
	\pgfusepath{draw}
	\pgfpathmoveto{\pgfpoint{0.8\pgf@circ@res@right}{1\pgf@circ@res@down}}
	\pgfpathlineto{\pgfpoint{.2\pgf@circ@res@right}{-0.5\pgf@circ@res@up}}
	\pgfusepath{draw}
	\endpgfscope
