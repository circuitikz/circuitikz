...
\long\def\drawbodydiode{
        \pgfscope
	         \pgftransformshift{\pgfpoint{-\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode distance}\pgf@circ@res@left}{\pgf@circ@res@up+\pgf@circ@res@down}}
	         \ifpgf@circuit@fet@ntype
		         \pgftransformrotate{90}
	         \else
		         \pgftransformrotate{-90}
	         \fi
			\pgftransformscale{\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode scale}}
		...
		\pgfpathmoveto{\pgfpoint{\pgf@circ@res@right}
						{\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode conn}\pgf@circ@res@up}}
		\pgfpathlineto{\pgfpoint{-\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode distance}\pgf@circ@res@left}
						{\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode conn}\pgf@circ@res@up}}
	       \ifpgf@circuit@fet@ntype
      ...
      \endpgfscope{}
	   ...
	   \pgfpathmoveto{\pgfpoint{\pgf@circ@res@right}
	        {\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode conn}\pgf@circ@res@down}}
		\pgfpathlineto{\pgfpoint{-\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode distance}\pgf@circ@res@left}{\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode conn}\pgf@circ@res@down}}
	       \ifpgf@circuit@fet@ntype
			 	\pgfpathlineto{\pgfpointanchor{pgf@bodydiode}{west}}
	       \else
				\pgfpathlineto{\pgfpointanchor{pgf@bodydiode}{east}}
		...
		\pgfusepath{draw}
		\pgfscope
		        \pgftransformshift{\pgfpoint{\pgf@circ@res@right}		        	       {\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/bodydiode conn}\pgf@circ@res@down}}
   	       		\pgftransformscale{0.5}
		        \pgfnode{circ}{center}{}{}{\pgfusepath{fill}}
		      \endpgfscope
}
...
\pgfcircdeclarefet{nigfete}{
      ...
      \anchor{G}{
         \northeast
         \pgf@circ@res@step=\pgfkeysvalueof{/tikz/circuitikz/tripoles/\currentname/gate height}\pgf@y
         \left
         \pgf@y=-\pgf@circ@res@step
      }
      \anchor{gate}{
