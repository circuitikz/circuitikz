...
\pgfdeclareshape{oscillator}	% The oscillator is shifted to the left, so a connection comes out of the anchor "east"
{
	\savedanchor\northwest{
		\ifpgf@circuit@boxed
			\pgf@y= \pgfkeysvalueof{/tikz/circuitikz/bipoles/length}
	...
	\backgroundpath{
		...
		\pgfscope
			...
			\else
				\pgfsetlinewidth{\pgfkeysvalueof{/tikz/circuitikz/bipoles/thickness}\pgfstartlinewidth}
			\fi
			\pgfpathcircle{\pgfpoint{-0.5\pgf@circ@res@step}{0}} {0.5\pgf@circ@res@step}
			\pgfusepath{draw}
			...
			\pgfpathmoveto{\pgfpoint{-0.8\pgf@circ@res@step}{0\pgf@circ@res@step}}
			...
			% draw outer box
			\ifpgf@circuit@boxed{}
				\pgftransformxshift{-0.5\pgf@circ@res@step}
				\pgfnode{box}{center}{}{pgf@box}{\pgfusepath{draw}}
			\fi
		\endpgfscope				  
	}
