...
\def\pgf@circ@muxdemux@label@xy#1#2#3#4#5#6#7{%
    ...
    \pgfscope
        ...
        \pgfmathsetlength\pgf@circ@res@temp{\pgfkeysvalueof{\circuitikzbasekey/muxdemux/#7 label xsep}}
        ...
        \pgftransformyshift{#4\pgf@circ@res@other}
...
\pgfdeclareshape{muxdemux}{
    ...
    \pgf@circ@draw@component{%
        ...
        \ifnum\quadrant=2
            ...
            \pgf@circ@muxdemux@label@xy{Ni}{180}{0}{1}{bottom}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
        \else
            \pgf@circ@muxdemux@label@xy{N}{0}{0}{1}{bottom}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
            \pgf@circ@muxdemux@label@xy{Ni}{0}{0}{-1}{top}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
        \fi
        \endpgfscope
        % go south!
        \pgfscope
        ...
        \ifnum\quadrant=2
            ...
            \pgf@circ@muxdemux@label@xy{Si}{180}{0}{-1}{top}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
        \else
            \pgf@circ@muxdemux@label@xy{S}{0}{0}{-1}{top}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
            \pgf@circ@muxdemux@label@xy{Si}{0}{0}{1}{bottom}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
        \fi
        \endpgfscope
        % go west!
        \pgfscope
        ...
        \ifnum\quadrant=3
            ...
            \pgf@circ@muxdemux@label@xy{Wi}{-90}{0}{1}{bottom}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
        \else
            \pgf@circ@muxdemux@label@xy{W}{90}{0}{1}{bottom}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
            \pgf@circ@muxdemux@label@xy{Wi}{90}{0}{-1}{top}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
        \fi
        \endpgfscope
        % go east!
        \pgfscope
        ...
        \ifnum\quadrant=3
            ...
            \pgf@circ@muxdemux@label@xy{Ei}{-90}{0}{-1}{top}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
        \else
            \pgf@circ@muxdemux@label@xy{E}{90}{0}{-1}{top}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
            \pgf@circ@muxdemux@label@xy{Ei}{90}{0}{1}{bottom}{pgfcirc@nop}{border}% type, rot, pad x, pad y, text pos, op, type
        \fi
        \endpgfscope
