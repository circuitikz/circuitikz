...
\def\pgf@circ@muxdemux@label#1#2#3#4#5{%
    % #1: which label: L,R,T,B
    % #2: rotation
    % #3: padding sign
    % #4: padding axis (0->x, 1->y)
    % #5: text position
    % uses external variables \pgf@circ@count@a and \pgf@circ@res@other
    \pgftransformrotate{#2}
    \ifnum#4=0
        \pgftransformxshift{#3\pgf@circ@res@temp}
    \else
        \pgftransformyshift{#3\pgf@circ@res@temp}
    \fi
    ...
    \pgfkeysifdefined{\@@thislabel}{%
        \pgftext[#5]{\pgfkeysvalueof{\circuitikzbasekey/multipoles/muxdemux/label font}\pgfkeysvalueof{\@@thislabel}}
    }{}
}
        ...
        \ifnum\NL>0\relax
            ...
            \pgfmathloop%
                ...
                \ifcase\quadrant % rotation 0; left label are at the left
                    \pgf@circ@muxdemux@label{L}{0}{+}{0}{left}% type, rot, pad sign, pad axis, text pos
                \or %rotation -90; left labels are at the top
                    \pgf@circ@muxdemux@label{L}{90}{-}{1}{top}% type, rot, pad sign, pad axis, text pos
                \or %rotation 180; left labels are at the right
                    \pgf@circ@muxdemux@label{L}{180}{-}{0}{right}% type, rot, pad sign, pad axis, text pos
                \or %rotation +90; left labels are at the bottom
                    \pgf@circ@muxdemux@label{L}{-90}{+}{1}{bottom}% type, rot, pad sign, pad axis, text pos
                \fi
            \endpgfscope
            \advance\pgf@circ@count@a by -1\relax%
            \repeatpgfmathloop
        ...
        \ifnum\NR>0\pgf@circ@count@a=\NR\relax
            ...
            \pgfscope
                ...
                \ifcase\quadrant % rotation 0; right label are at the right
                    \pgf@circ@muxdemux@label{R}{0}{-}{0}{right}% type, rot, pad sign, pad axis, text pos
                \or %rotation -90; right labels are at the bottom
                    \pgf@circ@muxdemux@label{R}{90}{+}{1}{bottom}% type, rot, pad sign, pad axis, text pos
                \or %rotation 180; right labels are at the left
                    \pgf@circ@muxdemux@label{R}{180}{+}{0}{left}% type, rot, pad sign, pad axis, text pos
                \or %rotation +90; right labels are at the top
                    \pgf@circ@muxdemux@label{R}{-90}{-}{1}{top}% type, rot, pad sign, pad axis, text pos
                \fi
            \endpgfscope
            \advance\pgf@circ@count@a by -1\relax%
            \repeatpgfmathloop
        ...
        \ifnum\NB>0\pgf@circ@count@a=\NB\relax %%%
            ...
            \pgfscope
                ...
                \ifcase\quadrant % rotation 0; bottom label are at the bottom
                    \pgf@circ@muxdemux@label{B}{0}{+}{1}{bottom}% type, rot, pad sign, pad axis, text pos
                \or %rotation -90; bottom labels are at the left
                    \pgf@circ@muxdemux@label{B}{90}{+}{0}{left}% type, rot, pad sign, pad axis, text pos
                \or %rotation 180; bottom labels are at the top
                    \pgf@circ@muxdemux@label{B}{180}{-}{1}{top}% type, rot, pad sign, pad axis, text pos
                \or %rotation +90; bottom labels are at the right
                    \pgf@circ@muxdemux@label{B}{-90}{-}{0}{right}% type, rot, pad sign, pad axis, text pos
                \fi
            \endpgfscope
            \advance\pgf@circ@count@a by -1\relax%
            \repeatpgfmathloop
        ...
        \ifnum\NT>0\pgf@circ@count@a=\NT\relax
            ...
            \pgfscope
                ...
                \ifcase\quadrant % rotation 0; top label are at the top
                    \pgf@circ@muxdemux@label{T}{0}{-}{1}{top}% type, rot, pad sign, pad axis, text pos
                \or %rotation -90; top labels are at the right
                    \pgf@circ@muxdemux@label{T}{90}{-}{0}{right}% type, rot, pad sign, pad axis, text pos
                \or %rotation 180; top labels are at the bottom
                    \pgf@circ@muxdemux@label{T}{180}{+}{1}{bottom}% type, rot, pad sign, pad axis, text pos
                \or %rotation +90; top labels are at the left
                    \pgf@circ@muxdemux@label{T}{-90}{+}{0}{left}% type, rot, pad sign, pad axis, text pos
                \fi
            \endpgfscope
            \advance\pgf@circ@count@a by -1\relax%
            \repeatpgfmathloop
