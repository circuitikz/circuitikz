...
%
% Thanks to @marmot
% this should automatically create a key in this subfaimly
...
\ctikzset{multipoles/muxdemux/label font/.initial=\pgf@circ@font@tiny}
\ctikzset{multipoles/muxdemux/external label font/.initial=\pgf@circ@font@tiny}
\ctikzset{multipoles/muxdemux/label padding/.initial=2pt}
...
\def\pgf@circ@muxdemux@label@xy#1#2#3#4#5#6#7{%
    ...
    % #7: font key
    % uses external variables \pgf@circ@count@a and \pgf@circ@res@temp
    \pgfscope
        \pgftransformrotate{#2}
        \pgftransformxshift{#3\pgf@circ@res@temp}
        \pgftransformyshift{#4\pgf@circ@res@temp}
        ...
        \pgfkeysifdefined{\@@thislabel}{%
            \pgftext[#5]{\pgfkeysvalueof{\circuitikzbasekey/multipoles/muxdemux/#7}%
...
\pgfdeclareshape{muxdemux}{
    ...
    \pgf@circ@draw@component{%
        ...
        \else
            ...
            \pgfmathsetmacro{\quadrant}{0}
        \fi
        % padding for internal labels (the first one to be used)
        \pgfmathsetlength\pgf@circ@res@temp{\pgfkeysvalueof{\circuitikzbasekey/multipoles/muxdemux/label padding}}
        % left pins
        \ifnum\NL>0\relax
            \pgf@circ@count@a=\NL\relax
            \pgf@circ@count@b=\NL \divide\pgf@circ@count@b by 2 % see https://tex.stackexchange.com/questions/146523/why-does-numexpr-integer-division-round-rather-than-truncate
            ...
            \pgfmathloop%
                ...
                \ifcase\quadrant % rotation 0; left label are at the left
                    \pgf@circ@muxdemux@label@xy{L}{0}{1}{0}{left}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{LU}{0}{-1}{1}{bottom}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{LD}{0}{-1}{-1}{top}{llap}{external label font}%
                \or %rotation -90; left labels are at the top
                    \pgf@circ@muxdemux@label@xy{L}{90}{0}{-1}{top}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{LU}{90}{-1}{1}{bottom}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{LD}{90}{1}{1}{bottom}{rlap}{external label font}%
                \or %rotation 180; left labels are at the right
                    \pgf@circ@muxdemux@label@xy{L}{180}{-1}{0}{right}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{LU}{180}{1}{1}{bottom}{rlap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{LD}{180}{1}{-1}{top}{rlap}{external label font}%
                \or %rotation +90; left labels are at the bottom
                    \pgf@circ@muxdemux@label@xy{L}{-90}{0}{1}{bottom}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{LU}{-90}{-1}{-1}{top}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{LD}{-90}{1}{-1}{top}{rlap}{external label font}%
                \fi
            \endpgfscope
            \advance\pgf@circ@count@a by -1\relax%
            \repeatpgfmathloop
        ...
        \ifnum\NR>0\pgf@circ@count@a=\NR\relax
            ...
            \pgfscope
                ...
                \ifcase\quadrant % rotation 0; right label are at the right
                    \pgf@circ@muxdemux@label@xy{R}{0}{-1}{0}{right}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{RU}{0}{1}{1}{bottom}{rlap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{RD}{0}{1}{-1}{top}{rlap}{external label font}%
                \or %rotation -90; right labels are at the bottom
                    \pgf@circ@muxdemux@label@xy{R}{90}{0}{1}{bottom}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{RU}{90}{-1}{-1}{top}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{RD}{90}{1}{-1}{top}{rlap}{external label font}%
                \or %rotation 180; right labels are at the left
                    \pgf@circ@muxdemux@label@xy{R}{180}{1}{0}{left}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{RU}{180}{-1}{1}{bottom}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{RD}{180}{-1}{-1}{top}{llap}{external label font}%
                \or %rotation +90; right labels are at the top
                    \pgf@circ@muxdemux@label@xy{R}{-90}{0}{-1}{top}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{RU}{-90}{-1}{1}{bottom}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{RD}{-90}{1}{1}{bottom}{rlap}{external label font}%
                \fi
            \endpgfscope
            \advance\pgf@circ@count@a by -1\relax%
            \repeatpgfmathloop
        ...
        \ifnum\NB>0\pgf@circ@count@a=\NB\relax %%%
            ...
            \pgfscope
                ...
                \ifcase\quadrant % rotation 0; bottom label are at the bottom
                    \pgf@circ@muxdemux@label@xy{B}{0}{0}{1}{bottom}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{BL}{0}{-1}{-1}{top}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{BR}{0}{1}{-1}{top}{rlap}{external label font}%
                \or %rotation -90; bottom labels are at the left
                    \pgf@circ@muxdemux@label@xy{B}{90}{1}{0}{left}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{BL}{90}{-1}{1}{bottom}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{BR}{90}{-1}{-1}{top}{llap}{external label font}%
                \or %rotation 180; bottom labels are at the top
                    \pgf@circ@muxdemux@label@xy{B}{180}{0}{-1}{top}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{BL}{180}{-1}{1}{bottom}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{BR}{180}{1}{1}{bottom}{rlap}{external label font}%
                \or %rotation +90; bottom labels are at the right
                    \pgf@circ@muxdemux@label@xy{B}{-90}{-1}{0}{right}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{BL}{-90}{1}{1}{bottom}{rlap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{BR}{-90}{1}{-1}{top}{rlap}{external label font}%
                \fi
            \endpgfscope
            \advance\pgf@circ@count@a by -1\relax%
            \repeatpgfmathloop
        ...
        \ifnum\NT>0\pgf@circ@count@a=\NT\relax
            ...
            \pgfscope
                ...
                \ifcase\quadrant % rotation 0; top label are at the top
                    \pgf@circ@muxdemux@label@xy{T}{0}{0}{-1}{top}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{TL}{0}{-1}{1}{bottom}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{TR}{0}{1}{1}{bottom}{rlap}{external label font}%
                \or %rotation -90; top labels are at the right
                    \pgf@circ@muxdemux@label@xy{T}{90}{-1}{0}{right}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{TL}{90}{1}{1}{bottom}{rlap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{TR}{90}{1}{-1}{top}{rlap}{external label font}%
                \or %rotation 180; top labels are at the bottom
                    \pgf@circ@muxdemux@label@xy{T}{180}{0}{1}{bottom}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{TL}{180}{-1}{-1}{top}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{TR}{180}{1}{-1}{top}{rlap}{external label font}%
                \or %rotation +90; top labels are at the left
                    \pgf@circ@muxdemux@label@xy{T}{-90}{1}{0}{left}{pgfcirc@nop}{label font}% type, rot, pad x, pad y, text pos, op, font
                    \pgf@circ@muxdemux@label@xy{TL}{-90}{-1}{1}{bottom}{llap}{external label font}%
                    \pgf@circ@muxdemux@label@xy{TR}{-90}{-1}{-1}{top}{llap}{external label font}%
                \fi
            \endpgfscope
            \advance\pgf@circ@count@a by -1\relax%
            \repeatpgfmathloop
