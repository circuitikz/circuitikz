...
\def\pgfcirc@twoport@shuffle@texts#1#2{% #1 IN, #2 OUT
...
\long\def\pgfcirc@define@twoports@circle#1#2#3#4#5#6#7{
\pgfcircdeclarebipolescaled{#1}
    {#2}
    {#3}
    {#4}
...
{\ctikzvalof{bipoles/twoportsplit/width}}
{
    ...
    % shuffle text depending on rotation
    \pgfcirc@twoport@shuffle@texts{\pgfcirc@tin}{\pgfcirc@tout}
...
\pgfcirc@define@twoports@circle{blocks}
{}
...
{
    % shuffle text depending on rotation
    \pgfcirc@twoport@shuffle@texts{A}{D}
    \pgfcirc@twoport@draw@splitline
    %
    \pgf@circ@text@strokecolor
...
{
    % shuffle text depending on rotation
    \pgfcirc@twoport@shuffle@texts{D}{A}
    \pgfcirc@twoport@draw@splitline
    %
    \pgf@circ@text@strokecolor
    \pgftext[center,x=0.45\pgf@circ@res@left,y=0.45\pgf@circ@res@up]{\textsf{\texti}}
