...
%	\pgfpathmoveto{\pgfpoint{0.75\pgf@circ@res@left}{\pgf@circ@res@zero}}
	\pgfpathcircle{\pgfpoint{0.2\pgf@circ@res@left}{6}}{6}
	\pgfusepath{draw}

	\pgfpathcircle{\pgfpoint{0\pgf@circ@res@left}{6}}{6}
	\pgfusepath{draw}
...
\def\pgf@circ@fiber@path#1{\pgf@circ@bipole@path{fiber}{#1}}
\compattikzset{fiber/.style = {\circuitikzbasekey,
/tikz/to path=\pgf@circ@fiber@path, l=#1}}
% %>>>
