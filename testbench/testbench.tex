...
\newcommand{\pathcmd}{\draw (0,0) to[variable cute inductor] ++(3,0) to[R] ++(3,0) to[variable american inductor] ++(3,0);}
\begin{document}
\begin{tikzpicture}[scale=0.5,rotate=40,transform shape]
